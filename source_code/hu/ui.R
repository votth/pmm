...
shinyUI(fluidPage(
	...
	sidebarPanel(
		...
		sliderInput(
			"S", "Kezdeti [S]zubstrát koncen.:",
			value=100, min=0, max=100, step=0.1
		),
		sliderInput(
			"E", "Kezdeti [E]nzim koncen.:",
	...
	mainPanel(
		tabsetPanel(
			...
			tabPanel("Leírások",
				h3("Egy enzimkatalizált reakció összefoglalása"),
